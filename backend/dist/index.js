...
const parser_1 = require("./src/analyzer/parser");
const Interpreter_1 = require("./src/interpreter/Interpreter");
const ASTReport_1 = require("./src/reports/ASTReport");
const ErrorReport_1 = require("./src/reports/ErrorReport");
const SymbolReport_1 = require("./src/reports/SymbolReport");
